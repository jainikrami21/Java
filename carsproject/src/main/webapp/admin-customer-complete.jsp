...
<!--[if IE]>
        ...
        <![endif]-->
<title>Admin- Customer- Complete -List- CarsWash- AutoWash</title>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Customer-Complete-Services</h4>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Customer-Complete-Services Table</div>
