...
<!--[if IE]>
        ...
        <![endif]-->
<title>Admin- Customer- Reject -List- CarsWash- AutoWash</title>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Customer-Reject-Services</h4>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Customer-Reject-Services Table</div>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										...
										<%List<BookService> list = BookingDao.getRejectServiceByCustomerId(s.getId()); %>
