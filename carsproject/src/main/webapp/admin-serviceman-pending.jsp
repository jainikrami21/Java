...
<!--[if IE]>
        ...
        <![endif]-->
<title>Admin- ServiceMan- Pending-List- CarsWash- AutoWash</title>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">ServiceMan-Pending-Services</h4>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">ServiceMan-Pending-Services Table</div>
