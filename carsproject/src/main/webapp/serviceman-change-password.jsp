...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan - Change - Password - AutoWash - Car Wash Website Template</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">Login</a>
                        <a href="">ServiceMan-Change-Password</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                    <p>// ServiceMan Change Password //</p>
                    <h2>ServiceMan Change Password</h2>
                </div>
                    ...
                    <div class="col-md-7">
                        <div class="contact-form">
                            ...
                            <form action="ServicemanController" method="post" >
                                ...
                                <div>
                                    <button class="btn btn-custom" name="action" value="change password" type="submit" >Change Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
