...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan - Manage - Service - AutoWash - Car Wash Website Template</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">Login</a>
                        <a href="">ServiceMan-Manage-Service</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                    <p>// ServiceMan-Manage-Service //</p>
                    <h2>ServiceMan-Manage-Service</h2>
                </div>
