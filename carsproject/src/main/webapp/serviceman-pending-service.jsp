...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan-Pending-Services - AutoWash - Car Wash Website Template</title>
    ...
    <body>
        ...
        <div class="page-header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>ServiceMan-Pending-Services</h2>
                    </div>
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">Login</a>
                        <a href="">ServiceMan-Pending-Services</a>
                    </div>
                </div>
            </div>
        </div>
				...
				<table class="table">
					...
					<%for(BookService s1:list){ %>
						...
						<tr>
							...
							<td><a href="BookingController?action=reject&bid=<%=s1.getBid()%>">Reject</a></td>
						</tr>
						<%} %>
					</tbody>
				</table>
