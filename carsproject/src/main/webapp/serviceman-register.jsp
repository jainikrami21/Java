...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan - Register - AutoWash - Car Wash Website Template</title>
        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                    <p>// ServiceMan Register //</p>
                    <h2>ServiceMan Register</h2>
                </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form action="ServicemanController" method="post" >
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="password" class="form-control" id="subject" name="password" placeholder="Password" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                
                                <div>
                                    <button class="btn btn-custom" name="action" value="register" type="submit" >Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
