...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan-Reject-Services - AutoWash - Car Wash Website Template</title>
    ...
    <body>
        ...
        <div class="page-header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>ServiceMan-Reject-Services</h2>
                    </div>
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">Login</a>
                        <a href="">ServiceMan-Reject-Services</a>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
			<div class="col-lg-12">
				<table class="table">
					...
					<tbody>
					<%List<BookService> list = BookingDao.getRejectServiceByServicemanId(s.getId()); %>
