...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>ServiceMan - Upload - Service - AutoWash - Car Wash Website Template</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">Login</a>
                        <a href="">ServiceMan-Upload-Service</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                    <p>// ServiceMan-Upload-Service //</p>
                    <h2>ServiceMan-Upload-Service</h2>
                </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form action="ServiceController" method="post" >
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="duration" placeholder="Duration" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>                                
                                <div>
