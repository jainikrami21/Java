...
public class ProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("upload")){
			String savePath = "C:\\Users\\PARUL\\eclipse-workspace\\e-commerce\\src\\main\\webapp\\image";   
		    ...
		    String savePath2 = "C:\\Users\\PARUL\\eclipse-workspace\\e-commerce\\src\\main\\webapp\\image";
			...
			String savePath = "C:\\Users\\PARUL\\eclipse-workspace\\e-commerce\\src\\main\\webapp\\assets\\images";   
			File fileSaveDir=new File(savePath);
	        if(!fileSaveDir.exists()){
	            fileSaveDir.mkdir();
	        }
		    ...
		    String savePath2 = "C:\\Users\\PARUL\\eclipse-workspace\\e-commerce\\src\\main\\webapp\\assets\\images";
	        File imgSaveDir=new File(savePath2);
	        if(!imgSaveDir.exists()){
	            imgSaveDir.mkdir();
	        }
