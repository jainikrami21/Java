				...
				<div class="col-md-12 contact-right-content">
					<form id="subscribe" action="ProductController" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="text" class="form-control" id="pname" name="pname" placeholder="Product Name" Value="<%=p.getPname()%>" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                	<label for="name">Product Price</label>
                                    <input type="text" class="form-control" id="pprice" name="pprice" placeholder="Product Price" value="<%=p.getPprice() %>" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                	<label for="name">Product Category</label>
                                    <input type="text" class="form-control" id="pcategory" name="pcategory" placeholder="Product Category" value="<%=p.getPcategory() %>" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
                                	<label for="name">Product Describe</label>
                                    <input type="text" class="form-control" id="pdesc" name="pdesc" placeholder="Product Describe" value="<%=p.getPdesc() %>" required="required" />
                                    <p class="help-block text-danger"></p>
                                </div>
