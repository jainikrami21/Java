...
<title>E-Commerce Website - User Register Page</title>
		...
		<div class="container">
			<div class="row">
				<div class="card w-50 mx-auto my-5">
					...
					<div class="card-body">
						<form id="subscribe" name="sentMessage" action="UserController" method="post">
							...
							<div class="form-group">
								...
								<input name="contact" 
									...
									data-validation-required-message="Please enter a Contact" />
							</div>
							<div class="form-group">
							...
							<div class="text-center">
								<button type="submit" id="sendMessageButton" name="action" value="register" class="main-dark-button">Register</button>
							</div>
						</form>
					</div>
				</div>
